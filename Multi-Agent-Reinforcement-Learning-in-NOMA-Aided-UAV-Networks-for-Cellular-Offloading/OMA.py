...
class SystemModel(object):
    ...
    def Get_Channel_Gain_OMA(self,UAVsnumber,Usersnumber,PropergationLosslist,UserAssociationlist,Noise_Power):# this function is for calculating channel gain
